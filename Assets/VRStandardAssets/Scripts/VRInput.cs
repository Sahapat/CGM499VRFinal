...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInput : MonoBehaviour
    {
        ...
        private void CheckInput()
        {
            ...
            #endregion
            m_MousePosition = OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote);

            if (Input.GetButtonUp("Fire1") || OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTrackedRemote)
                                           || OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.RTrackedRemote)) // Edit for GearVR Controller)
            {
                // If anything has subscribed to OnUp call it.
